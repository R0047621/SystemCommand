            ...
            <div class="margin_bottom">
              ...
              >
                ...
                <a-tab-pane v-for="item in projectList" :key="item.ID">
                  <template #tab>
                    <!-- 每个选项卡的内容 -->
                    <div class="flex items-center" @click="indexItem(item.ID)">
                      <!-- 图标和项目名称 -->
...
const NewsList = ref([
  { ID: 5, Test: "@我", Icon: "iconoir:page" },
  { ID: 6, Test: "通知", Icon: "ph:star-light" },
  { ID: 7, Test: "私信", Icon: "bi:briefcase-fill" },
]);
...
const indexItem = ref((index: number) => {
