            ...
            <div v-else class="h-[75px] py-[15px] flex justify-between bottom">
              ...
              <div class="flex txt">
                <div class="flex items-center">
                  产品计划 <Icon icon="ph:arrow-right" />
                </div>
                <div class="flex items-center">
                  即将发布 <Icon icon="ph:arrow-right" />
                </div>
                <div class="flex items-center">
                  测试 <Icon icon="ph:arrow-right" />
                </div>
                <div class="flex items-center">
                  准备发布<Icon icon="ph:arrow-right" />
                </div>
...
import { featProject_templates } from "@/service";
